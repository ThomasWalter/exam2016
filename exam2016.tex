...
\question[8] {\bf Criblage à haut débit.} Le criblage à haut débit ({\it high-througput screening}) permet d'identifier, parmi de nombreuses molécules, lesquelles se lient à une protéine donnée. Le criblage à haut débit virtuel ({\it virtual high-throughput screening}) en est l'équivalent sur ordinateur.
\begin{parts}
...
\question[4] {\bf Apprentissage statistique.} 
\begin{parts}
...
\question[8] Figure 3
\begin{parts}
\part Expliquer la variable visualisée dans les graphiques de gauche
dans la figure 3.A (et B,D,E). 
\begin{solution}
